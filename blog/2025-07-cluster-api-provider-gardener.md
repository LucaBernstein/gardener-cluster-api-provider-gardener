...
CAPGa allows you to manage Kubernetes clusters using `cluster.x-k8s.io` declarative Cluster API manifests, with Gardener acting as the cloud-independent provider and cluster orchestrator.
